#' @title Sample Data for Small Area Estimation using Hierarchical Bayesian Method for Rao Yu Model under Beta Distribution
#'
#' @description Dataset to simulate Small Area Estimation using Hierarchical Bayesian Method for Rao-Yu Model under Beta Distribution.
...
#' \item Calculate \eqn{$\mu_{ij}=exp(\beta_{0}+\beta_{1}xdi1_{ij}+\beta_{2}xdi2_{ij}+v_{i}+u_{ij})/(1+\beta_{0}+\beta_{1}xdi1_{ij}+\beta_{2}xdi2_{ij}+v_{i}+u_{ij}$}
...
#' }
#' }
#' \item Auxiliary variables \code{xdi1,xdi2}, direct estimation \code{y}, \code{area}, \code{period}, and \code{vardir} are combined in a dataframe called \code{dataBetaAr1}
#' }
#'
#'
