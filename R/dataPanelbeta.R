#' @title Sample Data under Beta Distribution for Small Area Estimation using Hierarchical Bayesian Method for Rao Yu Model when \code{rho = 0}
#'
#' @description Dataset under Beta Distribution to simulate Small Area Estimation using Hierarchical Bayesian Method for Rao-Yu Model with rho = 0
...
#' \itemize{
#' \item Set coefficient \eqn{\beta_{0}=\beta_{1}=\beta_{2}=2}
