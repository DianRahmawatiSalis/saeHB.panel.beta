...
mean. For the reference, see Rao and Molina (2015, ISBN:978-1-118-73578-7).
...
* `Panel.beya()` This function gives estimation of y using Hierarchical Bayesian Rao Yu Model under Beta distribution when rho = 0
